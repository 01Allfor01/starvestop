...
export default function LoginPage() {
    ...
    // 1. 페이지 진입 시 기존 토큰이 있다면 삭제
    useEffect(() => {
        const existingToken = localStorage.getItem('accessToken');
        if (existingToken) {
            localStorage.removeItem('accessToken');
            console.log('기존 세션을 초기화했습니다.');
        }
    }, []);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (token) {
                ...
                throw new Error(`응답에 토큰이 없습니다. 받은 데이터: ${JSON.stringify(response)}`);
            }
        ...
        <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">신선한 음식을 더 저렴하게</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-black"
                                required
                            />
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-black"
                                required
                            />
                            <button
                                type="button"

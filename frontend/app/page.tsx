                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative hidden md:block">
                            <div className="relative">
                                ...
                                {/* 샐러드 이미지 */}
                                <div
                                    className="absolute -top-4 -right-4 z-20 bg-white rounded-2xl shadow-xl p-3 transform -rotate-6">
                                    <img
                                ...
                                {/* 샌드위치 이미지 */}
                                <div
                                    className="absolute -bottom-4 -left-4 z-20 bg-white rounded-2xl shadow-xl p-3 transform rotate-6">
                                    <img
...
function CountdownTimer({endTime}: { endTime: Date }) {
    ...
    return (
        <div
            className="absolute bottom-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-lg flex items-center space-x-1">
